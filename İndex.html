...
<body>
    ...
    <!-- Müzik: O gece dolunaydı (otomatik + loop) -->
    ...
    <div class="container">
        ...
        <div class="questions">
            <ol>
                ...
                <li>Tekrar karşılaşsak ne yapardın? Selam mı verirdin, yoksa yoluna mı devam ederdin?</li>
                <li>Benimle ilgili en çok neyi yanlış anladığını düşünüyorsun şimdi?</li>
                <li>Yeniden başlama şansımız olsa, aynı hataları yapar mıydık sence?</li>
                <li>Şu an hayatında biri var mı, yoksa hâlâ yalnız mısın?</li>
